...
HQ_OPLUSVERSION_ATTR(pcbVersion, "%s",oppoversion.pcbVersion);
HQ_OPLUSVERSION_ATTR(operatorName, "%s",oppoversion.operatorName);
HQ_OPLUSVERSION_ATTR(modemType, "%s",oppoversion.modemType);
HQ_OPLUSVERSION_ATTR(prjVersion, "%s",oppoversion.prjVersion);
HQ_OPLUSVERSION_ATTR(kboard, "%s",oppoversion.Kboard);
HQ_OPLUSVERSION_ATTR(mainboard, "%s",oppoversion.Mboard);
HQ_OPLUSVERSION_ATTR(ramSize, "%s",buff_oppo);
HQ_OPLUSVERSION_ATTR(bootMode, "%s",buff_oppo);
HQ_OPLUSVERSION_ATTR(serialID, "%s",buff_oppo);
