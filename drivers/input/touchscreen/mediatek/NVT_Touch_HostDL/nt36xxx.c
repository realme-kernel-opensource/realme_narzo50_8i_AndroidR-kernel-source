 ...
 *
 * $Revision: 64634 $
 * $Date: 2020-06-18 15:07:01 +0800 (週四, 18 六月 2020) $
 *
...
{
	char firmware_name_temp[] = "novatek_ts_fw0.bin";
	...
	if (strstr(saved_command_line, "nt36672c_tm_60hz_fhdp_dsi_vdo_zal5603") )
		...
		strncpy(novatek_firmware, firmware_name_temp, sizeof(firmware_name_temp));
