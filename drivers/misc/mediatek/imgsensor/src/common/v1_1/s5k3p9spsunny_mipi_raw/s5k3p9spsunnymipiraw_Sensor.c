...
#include "s5k3p9spsunnymipiraw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
		...
		.sensor_id = S5K3P9SPSUNNY_SENSOR_ID,
		/*Caohua.Lin@Camera.Driver add for 18011/18311  board 20180723*/
...
UINT32 S5K3P9SPSUNNY_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
