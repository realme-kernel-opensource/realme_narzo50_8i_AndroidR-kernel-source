...
void set_reg_spm_f26m_req(int val)
{
	if (val) {
		mt6781_store_pwr_ctrl(MT_SPM_DBG_SMC_UID_IDLE_PWR_CTRL,
				"reg_spm_f26m_req 1",
				sizeof("reg_spm_f26m_req 1"));
	} else {
		mt6781_store_pwr_ctrl(MT_SPM_DBG_SMC_UID_IDLE_PWR_CTRL,
				"reg_spm_f26m_req 0",
				sizeof("reg_spm_f26m_req 0"));
	}

	return;
}
EXPORT_SYMBOL(set_reg_spm_f26m_req);
