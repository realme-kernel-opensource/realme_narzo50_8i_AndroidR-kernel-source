...
#define SENSOR_TYPE_OPLUS_ACTIVITY_RECOGNITION          (OPLUS_VIRTAUL_SENSOR_START + 7)
//#endif //OPLUS_FEATURE_ACTIVITY_RECOGNITION
/* end sensor type */
#define SENSOR_TYPE_SENSOR_MAX                         (SENSOR_TYPE_OPLUS_ACTIVITY_RECOGNITION +1)
...
//#endif //OPLUS_FEATURE_ACTIVITY_RECOGNITION
/* end sensor ID */
#define ID_SENSOR_MAX    (ID_OPLUS_ACTIVITY_RECOGNITION + 1)
typedef struct {
    uint32_t value;
