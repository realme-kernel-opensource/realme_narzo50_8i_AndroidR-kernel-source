...
#include "P24C128E/P24C128E.h"


#define MAX_EEPROM_SIZE_16K 0x4000

struct stCAM_CAL_FUNC_STRUCT g_camCalCMDFunc[] = {
        {S5KJN1_SENSOR_ID, 0xA0, P24C128E_selective_read_region},
        {S5K3P9SPSUNNY_SENSOR_ID, 0xA8, P24C128E_selective_read_region},
...
struct stCAM_CAL_LIST_STRUCT g_camCalList[] = {
	{GC02M1HLT_SENSOR_ID, 0xA4, Common_read_region},
	{GC02M1SHINE_SENSOR_ID, 0xA4, Common_read_region},
	{S5KJN1_SENSOR_ID, 0xA0, Common_read_region},
	{HI1634Q_SENSOR_ID, 0xA8, Common_read_region},
	{S5K3P9SPSUNNY_SENSOR_ID, 0xA8, Common_read_region},
