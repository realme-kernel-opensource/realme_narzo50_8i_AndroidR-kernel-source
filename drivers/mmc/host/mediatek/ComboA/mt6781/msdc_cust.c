...
//vendor 2021/5/13, add quick power off for tf card,start
void msdc_sd_power_off_quick(void)
{
	pmic_config_interface_nolock(PMIC_RG_LDO_VMCH_SW_OP_EN_ADDR,1,PMIC_RG_LDO_VMCH_SW_OP_EN_MASK,PMIC_RG_LDO_VMCH_SW_OP_EN_SHIFT);
	pmic_config_interface_nolock(REG_VMCH_EN,0, MASK_VMCH_EN,SHIFT_VMCH_EN);
	pr_err("sdcard removed and power off VMCH first!\n");
}
//vendor 2021/5/13, add quick power off for tf card,end
