...
#elif defined(CONFIG_OPLUS_CHARGER_MTK6763) || defined(CONFIG_OPLUS_CHARGER_MTK6889)|| defined(CONFIG_OPLUS_CHARGER_MTK6853)  || defined(CONFIG_OPLUS_CHARGER_MTK6873) || defined(CONFIG_OPLUS_CHARGER_MTK6781)
#include <linux/module.h>
...
#include <linux/module.h>
#else
#include <mach/mt_typedefs.h>//wt remove it
...
{
#ifdef CONFIG_OPLUS_CHARGER_MTK
#if defined(CONFIG_OPLUS_CHARGER_MTK6763) || defined(CONFIG_OPLUS_CHARGER_MTK6771) || defined(CONFIG_OPLUS_CHARGER_MTK6873)|| defined(CONFIG_OPLUS_CHARGER_MTK6853) || defined(CONFIG_OPLUS_CHARGER_MTK6781)
	int ret = 0;
...
#endif
#if !defined(CONFIG_OPLUS_CHARGER_MTK6853) && !defined(CONFIG_OPLUS_CHARGER_MTK6781)
...
int bq25601d_input_current_limit_write(int value)
{
	...
	value = 1200;/*release input limit,set fastchg current*/
...
#if !defined(CONFIG_OPLUS_CHARGER_MTK6853)
...
#if defined (CONFIG_MTK_PMIC_CHIP_MT6353) || defined(CONFIG_OPLUS_CHARGER_MTK6763) || defined(CONFIG_OPLUS_CHARGER_MTK6771)|| defined(CONFIG_OPLUS_CHARGER_MTK6853) || defined(CONFIG_OPLUS_CHARGER_MTK6873) || defined(CONFIG_OPLUS_CHARGER_MTK6781)
...
#if defined(CONFIG_OPLUS_CHARGER_MTK6853) || defined(CONFIG_OPLUS_CHARGER_MTK6781)
/*hongzhenglong@ODM.HQ.BSP.CHG 2021/06/1 add for disable watchdog timer*/
	bq25601d_set_wdt_timer(REG05_BQ25601D_WATCHDOG_TIMER_DISABLE);
#else
	bq25601d_set_wdt_timer(REG05_BQ25601D_WATCHDOG_TIMER_40S);
#endif
...
#if !defined(CONFIG_OPLUS_CHARGER_MTK6853) || !defined(CONFIG_OPLUS_CHARGER_MTK6851) || !defined(CONFIG_OPLUS_CHARGER_MTK6781)
