...
/* wangcheng@ODM.Multimedia.LCD  2021/04/23 add for solver no connect lcm cannot poweron */
...
// wangcheng@MULTIMEDIA.DISPLAY.LCD 2021/07/01 add for solve no connect lcm cannot poweron
